...
import {FETCH_MOVIES, FETCH_MOVIES_SUCCESS, FETCH_MOVIES_FAILURE,
  ...
  SEARCH_MOVIE, SEARCH_MOVIE_SUCCESS, SEARCH_MOVIE_FAILURE,FETCH_RELATED, FETCH_RELATED_SUCCESS,FETCH_RELATED_FAILURE} from '../actions'
...
// const relatedMovies = (state = defaultStateList, action) => {
//   switch (action.type){
//     case FETCH_RELATED_MOVIES:
//       return Object.assign({}, state, {
//         isFetching:true
//       });
//     case FETCH_RELATED_MOVIES_SUCCESS:
//       return Object.assign({}, state, {
//         isFetching:false,
//         items:action.data
//       });
//     case FETCH_RELATED_MOVIES_FAILURE:
//       return Object.assign({}, state, {
//         isFetching:false,
//         error:action.data
//       });
...
//   }
// };
const relatedList = (state = defaultStateList, action) => {
  switch (action.type){
    case FETCH_RELATED:
      return Object.assign({}, state, {
        isFetching:true
